...
const BIA_PHONE_E164 = '558796239763'
...
export default function App() {
  ...
  const BIA_PHONE = '558796239763'
  const INSTAGRAM = 'https://instagram.com/historiascantadasbr'
  const WHATSAPP = `https://wa.me/${'558796239763'}`
  ...
  const footerCols = [
    ...
    { title: 'Empresa', links: [
      ...
      { label: 'Contato',   href: `https://wa.me/${'558796239763'}`, external: true },
      { label: 'Instagram', href: 'https://instagram.com/historiascantadasbr', external: true },
      { label: 'WhatsApp',  href: `https://wa.me/${'558796239763'}`, external: true },
    ]},
    { title: 'Legal', links: [

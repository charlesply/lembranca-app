...
const BIA_PHONE_E164 = '551153048588'
...
export default function App() {
  ...
  const BIA_PHONE = '551153048588'
  const INSTAGRAM = 'https://instagram.com/historiascantadasbr'
  const WHATSAPP = `https://wa.me/${'551153048588'}`
  ...
  const footerCols = [
    ...
    { title: 'Empresa', links: [
      ...
      { label: 'Contato',   href: `https://wa.me/${'551153048588'}`, external: true },
      { label: 'Instagram', href: 'https://instagram.com/historiascantadasbr', external: true },
      { label: 'WhatsApp',  href: `https://wa.me/${'551153048588'}`, external: true },
    ]},
    { title: 'Legal', links: [

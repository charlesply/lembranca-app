...
const BIA_PHONE_E164 = '5511915301862'
  ...
  return (
    <div className="result-root">
      ...
      <div className="container result-shell">
        ...
        {resultData?.unlocked && (() => {
          const supportNum = '5511915301862'
...
export default function App() {
  ...
  const BIA_PHONE = '5511915301862'
  const INSTAGRAM = 'https://instagram.com/historiascantadasbr'
  const WHATSAPP = `https://wa.me/${'5511915301862'}`
  ...
  const footerCols = [
    ...
    { title: 'Empresa', links: [
      ...
      { label: 'Contato',   href: `https://wa.me/${'5511915301862'}`, external: true },
      { label: 'Instagram', href: 'https://instagram.com/historiascantadasbr', external: true },
      { label: 'WhatsApp',  href: `https://wa.me/${'5511915301862'}`, external: true },
    ]},
    { title: 'Legal', links: [
